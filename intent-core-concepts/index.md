...
{%- if forloop.first -%}<td rowspan="{{c.conditions.size}}"><a class="self" href="#{{c.concept}}{{c.arityr}}{{c.property}}">{{c.concept}}</a></td>{%- endif -%}
{%- if forloop.first -%}<td rowspan="{{c.conditions.size}}">{{c.arityr}}</td>{%- endif -%}
...
{%- endfor -%}
{%- else -%}
<tr id="{{c.concept}}{{c.arityr}}{{c.property}}" class="row{{ clss }}">
<td><a class="self" href="#{{c.concept}}{{c.arityr}}{{c.property}}">{{c.concept}}</a></td>
<td>{{c.arityr}}</td>
