...
```
A [codepen](https://codepen.io/bkardell/pen/xxLKOxo?editors=1111) shows how this might work.
...
If `aria-label` is generated by the stylesheet, then many of the problems noted above about the use of `aria-label` apply to this technique.
